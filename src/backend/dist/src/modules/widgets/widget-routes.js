...
export async function registerWidgetRoutes(app, dependencies = createWidgetRouteDependencies()) {
...
function createWidgetRouteDependencies() {
    const prisma = getPrismaClient();
    return {
        widgetService: new WidgetService(new PrismaWidgetRepository(prisma), createSnapshotJobPublisherFromEnvironment()),
